...
namespace TTGarmentAdmin.Controllers
{
    public class DashboardController : Controller
    {
        ...
        public async Task<ActionResult> GetRegisteredRetailer(string filterType, string filterValue)
        {
            this.repository = new Repository();
            this.model = new DashboardModel();
            ...
            this.model.RetailerList = await this.repository.GetRegisteredRetailer();
        ...
        public async Task<ActionResult> GetProductView(string filterType, string filterValue)
        {
            this.repository = new Repository();
            this.model = new DashboardModel();
            this.model.ProductList = await this.repository.GetVehicleList();
        ...
        public async Task<ActionResult> GetRetailerPointsLedgerView(string filterType, string filterValue)
        {
            this.repository = new Repository();
            this.model = new DashboardModel();
            this.model.PointsLedger = await this.repository.GetPointsLedger();
